class UsersController < ApplicationController
  ...
  private
    ...
    def user_params
      params.require(:user).permit(:nickname, :email, :name, :surname, :location, :about_me, :contact_info, :company, :position, :slug, :role, :activity_status, :is_rejected, :reject_date, :reject_reason, :is_banned, :ban_date, :ban_reason, :telegram_id, :respect, :image)
    end
end
